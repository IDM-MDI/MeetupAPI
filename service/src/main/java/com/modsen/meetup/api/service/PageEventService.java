...
public interface PageEventService {
    ...
    ResponsePage<EventDto> save(EventDto event) throws ServiceException, PersistenceException;
    ResponsePage<EventDto> update(EventDto event, long id) throws ServiceException, PersistenceException;
    ResponsePage<EventDto> delete(long id) throws ServiceException, PersistenceException;
}
